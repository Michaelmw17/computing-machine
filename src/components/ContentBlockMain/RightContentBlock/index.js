      ...
      <Row type="flex" justify="space-between" align="middle" id={id}>
        <Col xs={{ span: 22, offset: 1 }} lg={{ span: 11, offset: 1 }}>
          <S.ContentWrapper>
            ...
            <Row type="flex" justify="center" id="Button-top">
              <Col xs={12} sm={24} md={24} lg={12} xl={12} id="Button-top">
                <S.ButtonWrapper id="Button-top">
                  {button &&
              ...
              <Col xs={24} sm={24} md={24} lg={12} xl={12} id="Button-top">
                <S.ButtonWrapper id="Button-top">
                  {button &&
                    typeof button === 'object' &&
                    button.map((item, id) => {
